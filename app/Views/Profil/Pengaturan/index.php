        ...
        <form id="formDetailProfil" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        <!--begin::Image input-->
                        <div class="image-input image-input-outline <?= ($pengguna->image_profile == null) ? 'image-input-empty' : ''; ?>" data-kt-image-input="true" style="background-image: url('/assets/media/svg/avatars/blank.svg')">
                            <!--begin::Preview existing avatar-->
                            <?php if ($pengguna->image_profile != null) : ?>
                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url(/assets/images/users/<?= $pengguna->image_profile; ?>)">
                                </div>
                            <?php else : ?>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                <input type="text" name="first_name" id="first_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Nama Depan" value="<?= ucwords(strtolower($pengguna->first_name)); ?>" autocomplete="off">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                <input type="text" name="last_name" id="last_name" class="form-control form-control-lg form-control-solid" placeholder="Nama Belakang" value="<?= ucwords(strtolower($pengguna->last_name)); ?>" autocomplete="off">
                ...
                <?php if ($pengguna->role != 'Dosen') : ?>
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <input type="text" name="npm" id="npm" class="form-control form-control-lg form-control-solid" placeholder="Nomor Pokok Mahasiswa" value="<?= $pengguna->npm; ?>" autocomplete="off">
