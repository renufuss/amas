...
<body style="background-color: #cfac00">
	<header class="site-header" id="header">
		<h1 class="site-header__title" data-lead-id="site-header-title" style="color: white;">Terima kasih!</h1>
	</header>

	<div class="main-content">
		<i class="fa fa-warning main-content__checkmark" id="checkmark" style="color: white;"></i>
	...
	<div class="agenda">
		...
		<p style="font-weight:600; letter-spacing: 1px;">Status : Terlambat</p>
